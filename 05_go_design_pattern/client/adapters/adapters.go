...
type CatBreedsInterface interface {
	...
	GetCatBreedsByName(b string) (*models.CatBreed, error)
}
...
func (jb *JSONBackend) GetCatBreedsByName(b string) (*models.CatBreed, error) {
...
func (jb *XMLBackend) GetCatBreedsByName(b string) (*models.CatBreed, error) {
...
func (tb *TestBackend) GetAllCatBreeds() ([]*models.CatBreed, error) {
	breeds := []*models.CatBreed{
		&models.CatBreed{ID: 1, Breed: "Tomcat", Details: "SomeDetails"},
	}

	return breeds, nil
}

func (jb *TestBackend) GetCatBreedsByName(b string) (*models.CatBreed, error) {
	return nil, nil
}
