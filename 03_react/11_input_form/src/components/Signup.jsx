...
export default function Signup() {
    const [passswordsAreNotEqual, setPassswordsAreNotEqual] = useState(false);
  ...
  function handleSubmit(event) {
    ...
    data.acquisiton = acquistionChannel;

    if (data.password !== data['confirm-password']) {
        setPassswordsAreNotEqual(true);
        return
    }
  }
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="control-row">
        ...
        <div className="control">
          ...
          <div className='control-error'>{passswordsAreNotEqual && <p>Passwords not Match.</p>}</div>
        </div>
      </div>
